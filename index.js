 ...
 */  
  var component = Control_Applicative.pure(Effect.applicativeEffect)(Halogen_Component.mkComponent({
      initialState: Data_Function["const"](0),
      render: Data_Function["const"](Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Hello, world!") ])),
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(component))(function (comp) {
          return Halogen_VDom_Driver.runUI(comp)(Data_Unit.unit)(body);
      });
  }));
  exports["main"] = main;
})(PS);
